...
function Projects() {
  ...
  return (
    <div className='r'>
      ...
      <div className="video-overlay-projects"></div>

      <div className="portfolio-premium-wrapper">
        <div className="header-content">
          <h2 className="main-title">Tanlangan Loyihalar</h2>
          <p className="subtitle">Muvaffaqiyatli loyihalar orasidan saralab olinganlari</p>
        </div>
        ...
        <div className="elite-projects-grid">
          {eliteProjects.map((pro) => (
            <div 
              ...
              key={pro.id}
              style={{ '--project-glow': pro.glow }} // CSS o'zgaruvchisi orqali rangni uzatamiz
            >
              <div className="elite-img-container">
                ...
                <div className="elite-overlay">
                  <a href={pro.link} target="_blank" rel="noopener noreferrer" className="visit-link">
                    Saytga o'tish <FaExternalLinkAlt />
                  </a>
                </div>
              </div>
